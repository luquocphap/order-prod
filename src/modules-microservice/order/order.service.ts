...
import { EMAIL_SERVICE } from 'src/common/constant/rabbitmq.constant';
import { ClientProxy } from '@nestjs/microservices';

@Injectable()
export class OrderService {
  constructor(private prisma: PrismaService, @Inject(EMAIL_SERVICE) private client: ClientProxy){}
